...
@pytest.mark.test_case_ids([90402])
def test_publish_to_OpenData_create_catalogue(page_setup) -> None:
    global title
    logging.info("Starting test: test_publish_to_OpenData_create_catalogue")
    page = page_setup
    
    # Create record title
    common_utils = CommonUtils(page)
    # Generate a unique title for the record
    title = "PublishToOpenData_"
...
@pytest.mark.dependency(depends=["test_publish_to_OpenData_create_catalogue"])
def test_publish_to_OpenData_approve_by_BDT(page_setup) -> None:     
...
@pytest.mark.dependency(depends=["test_publish_to_OpenData_approve_by_BDT"])
def test_publish_to_OpenData_approve_by_CDO(page_setup) -> None:
    global title
...
@pytest.mark.dependency(depends=["test_publish_to_OpenData_approve_by_CDO"])
def test_publish_to_OpenData_final_review(page_setup) -> None:
