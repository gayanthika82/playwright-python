...
@pytest.mark.test_case_ids([90025])
def test_abandon_releaseCriteria(page_setup) -> None:
    logging.info("Starting test_abandon_releaseCriteria")
    page = page_setup
    
    # Create record title
    common_utils = CommonUtils(page)
    title = "AbandonRecord_ReleaseCriteria"
