...
@pytest.mark.test_case_ids([90022,90398])
def test_abandon_confirmPublication(page_setup) -> None:
    
    logging.info("Starting test_abandon_confirmPublication")
    page = page_setup
    
    # Create record title
    common_utils = CommonUtils(page)
    title = "AbandonRecord_ConfirmDetails"
